...
export async function requestMask(url) {
    try {
        const body = JSON.stringify({
            "image_url" : `${url}`,
            "webhook_url" : "https://relife-inzzywwlb-yyangs-projects.vercel.app/api/webhook/mask"
        });
...
export async function requestGenerate(jobId, maskUrl) {
    try {
        ...
        const body = JSON.stringify({
            ...
            "generation_count" : 1,
            "webhook_url" : "https://relife-inzzywwlb-yyangs-projects.vercel.app/api/webhook/generate"
        });
